############################################################
#
#   $Id: TinyURL.pm 512 2006-05-28 22:34:11Z nicolaw $
...
$VERSION = '0.01' || sprintf('%d', q$Revision: 512 $ =~ /(\d+)/g);
$DEBUG = $ENV{DEBUG} ? 1 : 0;

$UA = LWP::UserAgent->new(
		timeout => 20,
		agent => __PACKAGE__ . ' $Id: TinyURL.pm 512 2006-05-28 22:34:11Z nicolaw $',
